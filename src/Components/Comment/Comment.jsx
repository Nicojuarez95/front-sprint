...
import deleteBtn from '../../images/delete-icon.png'
...
import subcomment from '../../images/Icon.png'
...
export default function Comment() {
    ...
    let url = 'http://localhost:8000/comments?chapter_id=' + id + '&page=' + page
    useEffect(() => {
        setTimeout(() => {
    ...
    async function handleDelete(e) {
        try {
            let url = 'http://localhost:8000/comments/' + e.target.id
